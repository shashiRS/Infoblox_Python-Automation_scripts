...
class NIOSSPT_10572(unittest.TestCase):
    ...
    def test_000_create_AD_Services(self):
        ...
        data={"ad_domain": "ad-41.local","domain_controllers": [{"auth_port": 389,"comment": "AD services","disabled": False,"encryption": "NONE","fqdn_or_ip": "10.102.20.31","use_mgmt_port": False}],"name": "adserver"}
    ...
    def test_006_validating_AD_services(self):
        ...
        try:
            child = pexpect.spawn('ssh -o StrictHostKeyChecking=no shekhar@'+config.grid_vip)
        ...
        LookFor=["Authorization succeeded for shekhar","Admin group asmgroupn found in remote method reply","AD Authentication Succeeded"]
        cnt=0
        for look in LookFor:
            print(look)
