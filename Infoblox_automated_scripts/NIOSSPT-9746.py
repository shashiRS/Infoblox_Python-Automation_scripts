...
class NIOSSPT_9746(unittest.TestCase):
    ...
    def test_002_create_IPv4_Range(self):
        ...
        data = {"network":"10.0.0.0/8","start_addr":"10.0.0.1","end_addr":"10.0.0.8","network_view": "default","member":{"_struct":"dhcpmember","ipv4addr":config.grid_vip}}
    ...
    def test_005_create_Fingerprint_Filter(self):
        print("Create_Fingerprint Filter Microsoft Windows XP (Version 5.1, 5.2)")
